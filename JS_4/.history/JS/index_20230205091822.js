...
document.getElementById('btnXepLoai').onclick = function () {
    ...
    var diemLy = Number(document.getElementById('diemToan')).value;

    var diemHoa = Number(document.getElementById('diemToan')).value;
    ...
    document.getElementById('diemTrungBinh').innerHTML = diemTrungBinh + "điểm" ;
