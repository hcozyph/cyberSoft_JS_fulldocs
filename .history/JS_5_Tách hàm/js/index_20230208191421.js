...
document.getElementById('btnTang').onclick = function () {
    //Tăng giá trị fontSize
    fontSize = fontSize + 5;
    

    //GOji hàm thay đổi fontSize
...
document.getElementById('colors').onclick = function () {
    //Xử lý lấy giá trị của input từ color
    var color = document.getElementById('colors').value;
    document.getElementById('home').style.color = color;
}
/////

//BT 2: Tăng giảm fontSize đoạn văn bản

var fontSizeText = 20;

document.getElementById('btnTangFont').onclick = function () {
    fontSizeText = fontSizeText + 5 ;
    changeFontSize('p-text',fontSizeText);
}

document.getElementById('btnGiam').onclick = function () {
    fontSizeText = fontSizeText - 5;
    changeFontSize('p',fontSizeText)
}